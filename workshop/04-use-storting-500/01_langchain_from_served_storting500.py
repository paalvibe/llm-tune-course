...
# MAGIC
# MAGIC Tuning:
# MAGIC workshop/01-TEACHER-tune/01-tune-mistral-storting/01_norsk_tune_qlora_500_runs
# MAGIC
# MAGIC Serving:
# MAGIC workshop/01-TEACHER-tune/07-serve-storting500-mistral/02_serve_storting500_1st_proxy_from_registry

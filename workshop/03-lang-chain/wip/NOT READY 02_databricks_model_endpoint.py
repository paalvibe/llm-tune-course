...
# MAGIC %md
# MAGIC # Manage dolly-v2-7b chat model with MLFlow on Databricks
# MAGIC
...
registered_name = "models.default.dolly_v2_7b_chat_model" # Note that the UC model name follows the pattern <catalog_name>.<schema_name>.<model_name>, corresponding to the catalog, schema, and registered model name
...
# MAGIC Once the model is registered, we can use API to create a Databricks GPU Model Serving Endpoint that serves the `dolly-v2-7b` model.
# MAGIC

# COMMAND ----------

# Provide a name to the serving endpoint
endpoint_name = 'dolly-v2-7b'

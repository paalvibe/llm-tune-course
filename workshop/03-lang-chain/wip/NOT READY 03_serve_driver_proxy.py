...
# MAGIC %md
# MAGIC
# MAGIC # Serving dolly-v2-7b with a cluster driver proxy app
# MAGIC
# MAGIC This notebook enables you to run Databricks' dolly-v2-7b, an instruction-following large language model trained on the Databricks machine learning platform, on a Databricks cluster and expose the model to LangChain via [driver proxy](https://python.langchain.com/en/latest/modules/models/llms/integrations/databricks.html#wrapping-a-cluster-driver-proxy-app).
# MAGIC
...
# MAGIC %md
# MAGIC
# MAGIC ## You might need to register to huggingface
...
# MAGIC import json
# MAGIC
# MAGIC def request_dolly-v2-7b(prompt, temperature=1.0, max_new_tokens=1024):
...
# MAGIC
# MAGIC
# MAGIC request_dolly-v2-7b("What is databricks?")
# MAGIC ```

...
model_output_location = "/local_disk0/mistral-7b-qlora-fine-tune-norskgpt-500serve"
local_output_dir = "/local_disk0/results-norskgpt-500serve"
mlflowmodel_name = "norsk7bqloramistral500serve"
volume_save_path = "/Volumes/training/data/tunedmodels/parliament/500serve"
...
# MAGIC %ls -lh /Volumes/training/data/tunedmodels/parliament/500server
...
# MAGIC %ls "/local_disk0/mistral-7b-qlora-fine-tune-norskgpt-500serve"
# MAGIC %ls "/local_disk0/results-norskgpt-500serve"

# COMMAND ----------

# MAGIC %md ## Serve model directly in this notebook with flask
...
gen_text_for_serving("Hvis jeg får korona og isolerer meg selv og det ikke er alvorlig, er det noen medisiner jeg kan ta"?, temperature=0.1, max_tokens=100)
...
constants_table = "training.llm_langchain_shared.storting250direct_server1_constants"
